...
$conn = mysqli_connect("mysql.railway.internal","root","UhMzqiSqKTqYJuSJxNMOuHvRqcasUVpb","stockbarang");
    ...
    if (isset($_GET['msg'])) {
        ...
        $folder = __DIR__ . '/storage_railway';
    ...
    if($hitung<1){
        ...
        if($ukuran==0){
            ...
            if($ukuran < 100000000){ //~ 10mb
                ...
                move_uploaded_file($file_tmp, __DIR__ . '/storage/'.$image); //Railway Path
...
if(isset($_POST['updatebarang'])){
    ...
    if($update){
        ...
        if($ukuran < 100000000){ //~ 10mb
            ...
            // move_uploaded_file($file_tmp, '/images/'.$image);
            move_uploaded_file($file_tmp, __DIR__ . '/storage/'.$image); // Path Railway
...
if(isset($_POST['hapusbarang'])){
    ...
    $img = __DIR__ . '/storage/'.$get['image']; //Railway path
    unlink($img);
