                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="masuk.php" style="background-color:#0ba7a7;">
                                <div class="sb-nav-link-icon" style="color:white;"><i class="fas fa-box"></i></div>
                                <b style="color:white;">Barang Masuk</b>
                            </a>
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    if(isset($_POST['filter_tgl'])){
                                        ...
                                        $ambilsemuadatastock = mysqli_query($conn,"select * from masuk m, stock s where s.idbarang = m.idbarang");//untuk joint table ke table stock
                                    }
...
<div class="modal fade" id="myModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <Select name="barangnya" class="form-control"><!--memilih-->
          <?php
            $ambilsemuadatanya = mysqli_query($conn,"select * from stock order by namabarang ASC");//ascending (berurut)
            while($fetcharray = mysqli_fetch_array($ambilsemuadatanya)){ //perulangan 
                $namabarangnya = $fetcharray['namabarang'];//database stock
